	...
	<div class="main">
		<div class="col-md-6 col-sm-12">
			<div class="login-form">
				<form method="post" autocomplete="off" onsubmit="ResetPasswordPage.submit();return false;" id="password_reset_form">
					<div class="m-3">
						...
						<div id="fields">
							<div class="mb-3">
								...
								<input type="text" autocomplete="username" class="form-control border" name="username" id="username" autofocus>
							</div>
							<div class="mb-5">
								<label for="email" class="form-label"><strong><?= t('register_mail'); ?>:</strong></label>
								<input type="email" autocomplete="email" class="form-control border" name="email" id="email">
							</div>
						</div>
