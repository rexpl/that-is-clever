...
socket.onmessage = function(e) {
	...
	if (typeof message['last_phase'] !== 'undefined') {
		...
		plus(message['last_phase']);

		inverted = message['last_phase'] ? false : true;
...
function new_round(argument) {
	...
	while (i < 3) {
		i++;
		document.getElementById(i + '-dice-div').style.backgroundColor = 'transparent';
		document.getElementById(i + '-dice-div').style.color = '#ffffff';
		document.getElementById(i + '-dice-text').innerHTML = '&nbsp;';
	}
...
function reply_dragstart(event, id) {
	...
	switch (selected_dice) {
		...
		case 'orange':
			...
			if (board['orange_position'] != 11)  possible_values.push('o-' + (board['orange_position']) + '-div');

		break;
		case 'purple':

			if (board['last_purple_value'] < dices['purple'] && board['purple_position'] != 11)  possible_values.push('p-' + (board['purple_position']) + '-div');
		...
		default: //white dice
			...
			if (board['last_purple_value'] < dices['white'] && board['purple_position'] != 11)  possible_values.push('p-' + (board['purple_position']) + '-div');
...
function replay_dragstartBonus(event, id) {
	...
	switch (bonusChoiceID) {
		...
		case 14:
			...
			if (board['orange_position'] != 11) possible_values.push('o-' + (board['orange_position']) + '-div');
			if (board['purple_position'] != 11) possible_values.push('p-' + (board['purple_position']) + '-div');
