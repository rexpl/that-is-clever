...
function Login(url, texts) {
	...
	this.submit = function() {
		...
		this.alertBox.classList.remove("animate__pulse");
		...
		xhttp.onreadystatechange = function() {
			...
			if (this.readyState == 4) {
				...
				_this.alertBox.classList.remove("alert-warning", "alert-danger", "alert-success");
				...
				if (this.status == 200) {
					...
					_this.fields.classList.add("invalid");
					_this.passwordField.focus();

					_this.alertBox.classList.add("alert-warning", "animate__pulse");
					...
					_this.alertBox.classList.add("alert-danger", "animate__pulse");
...
function PregameSolo(url, texts) {
	...
	this.button = document.getElementById("enter_button");

	this.create = function() {

		this.button.innerHTML = "<span class=\"spinner-border spinner-border-sm\"></span> Loading..";
		...
		xhttp.onreadystatechange = function() {
			...
			if (this.readyState == 4) {
				...
				if (this.status == 200) {
					...
					_this.alertBox.classList.add("alert-danger");
					_this.alertText.innerHTML = _this.texts.textUnexpectedError + ' (Error: E1014)';
					_this.alertBox.style.display = 'block';

				}

				_this.button.innerHTML = _this.texts.buttonText;
				_this.button.disabled = false;
			}
		}

		xhttp.open("GET", this.url + "/call/pregame/create?q=solo", true);
		xhttp.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
		xhttp.send();
